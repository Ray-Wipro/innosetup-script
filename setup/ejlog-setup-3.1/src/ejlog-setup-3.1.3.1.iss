...
[Icons]
Name: "{autoprograms}\startup\{#MyAppName}"; Filename: "{app}\Wms\{#MyMainProg}"; IconFilename: "{app}\Wms\tmp\wipro-0.ico"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\Wms\{#MyMainProg}"; IconFilename: "{app}\Wms\tmp\wipro-0.ico"; Comment: "EjLog WMS"
